                            ...
                            <div class="table-responsive table-custom-container">
                                <table class="table table-custom">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= PHP_VERSION ?></td>
                                        <td class="text-right">
                                            <?php if(version_compare(PHP_VERSION, '7.4.0', '>=') && version_compare(PHP_VERSION, '8.3', '<')): ?>
                                                ✅
                                            <?php else: ?>
                                                ❌
