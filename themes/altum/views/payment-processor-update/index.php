        ...
        <div class="card-body">
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('payment_processors.input.name') ?></label>
                ...
                <div>
                    ...
                    <div data-processor="paypal">
                        <button class="btn btn-block btn-gray-200 my-4" type="button" data-toggle="collapse" data-target="#paypal_instructions_container" aria-expanded="false" aria-controls="paypal_instructions_container">
                            <i class="fas fa-fw fa-question-circle fa-sm mr-1"></i> <?= l('payment_processors.input.instructions') ?>
                        </button>
