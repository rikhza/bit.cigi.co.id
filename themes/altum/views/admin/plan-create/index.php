                ...
                <?php if(\Altum\Plugin::is_active('aix')): ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="images_api" name="images_api" class="custom-select">
                            <option value="openai_dall_e">OpenAI - DALL E (<?= l('global.plan_settings.images_api.openai_dall_e') ?>)</option>
                            <option value="clipdrop">ClipDrop - StableDiffusion (<?= l('global.plan_settings.images_api.clipdrop') ?>)</option>
                        </select>
