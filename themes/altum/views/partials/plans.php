        ...
        <div class="mb-5 text-center">
            <div class="btn-group btn-group-toggle btn-group-custom" data-toggle="buttons">
                ...
                <?php if(isset($available_payment_frequencies['annual'])): ?>
                    <label class="btn <?= !isset($available_payment_frequencies['monthly']) ? 'active' : null ?>" data-payment-frequency="annual">
                ...
                <?php if(isset($available_payment_frequencies['lifetime'])): ?>
                    <label class="btn <?= !isset($available_payment_frequencies['monthly']) && !isset($available_payment_frequencies['annual']) ? 'active' : null ?>" data-payment-frequency="lifetime">
